# GRM188R71C104_DATASHEET_GRADE — Simulation Model Report
...
- Capacitance: **100.000 nF** (0.1 µF)
- Dielectric: X7R
- Voltage rating: 16 V
- ESR: 20.00 mΩ
- ESL: 0.633 nH
- SRF (datasheet): 20.00 MHz
- SRF (model): 19.95 MHz
...
| Check | Result | Detail |
|-------|--------|--------|
| Passivity | ✅ PASS | max(|S11|^2+|S21|^2) = 0.999887 (<=1 required) |
| Causality (finite, rational) | ✅ PASS | all S-parameters finite — rational/minimum-phase by construction |
| Stability / Re(Z)>=0 | ✅ PASS | min Re(Z) = 2.0000e-02 Ohm |
| SRF consistency | ✅ PASS | model 19.95 MHz vs datasheet 20.00 MHz (0.2% error) |
...
- ESL estimated from SRF: 0.633 nH (SRF=20.0 MHz) [PHYSICS ESTIMATE]
